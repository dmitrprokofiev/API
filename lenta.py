...
elements = dom.xpath("//div[@class='span4']/section[1]//div")
for el in elements:


names = dom.xpath("//div[@class='titles']//span//text()")
link = dom.xpath("//div[@class='titles']//@href")
date = dom.xpath("//div[@class='info g-date item__info']//span/span[1]//text()")
link = [url+i if 'lenta' not in i else i for i in link]
names = [i.replace('\xa0', '') for i in names]
